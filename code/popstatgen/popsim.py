...
class Pedigree:
    ...
    def path_to_relationship(self, path: PedPath) -> RelObj:
        ...
        for rel_attribute in relative_types.keys():
            # loops through each type within that attribute
            for rel_type, rel_info in relative_types[rel_attribute].items():
                sigs_match = True
        ...
        fh = True
        if 'fh' in relative_types['relationship'][rel_obj.relationship]:
            fh = relative_types['relationship'][rel_obj.relationship]['fh']
